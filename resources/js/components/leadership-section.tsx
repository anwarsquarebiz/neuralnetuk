            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div ref={gridRef} className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {leaders.map((leader, i) => (
                        <div
                            key={i}
                            className="group relative aspect-[3/4] overflow-hidden rounded-[2.5rem] bg-gray-100 shadow-xl transition-all duration-700"
                        >
                            {/* Image Container */}
                            <div className="absolute inset-0 grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0">
                                <picture>
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-10 transition-all duration-500 group-hover:translate-y-[-100%] group-hover:opacity-0">
                            ...
                            <div className="absolute inset-0 flex translate-y-full flex-col justify-end bg-[#000027]/90 p-10 backdrop-blur-md transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:translate-y-0">
