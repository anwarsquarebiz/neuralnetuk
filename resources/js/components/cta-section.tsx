...
export default function CTASection({
    ...
    return (
        <section ref={sectionRef} className="border-t border-blue-400/20 bg-[#000027] py-10 font-sans md:py-16">
            <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
                <div ref={contentRef} className="space-y-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 pt-4">
                        <Link href="/contact">
                            <Button className="flex h-12 items-center gap-2 rounded-lg bg-white px-8 font-bold text-[#000027] shadow-md hover:bg-white/90">
                                Talk to an Expert
