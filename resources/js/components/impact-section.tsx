    ...
    return (
        <section className="relative py-24 bg-gray-900 text-white font-sans overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-[url('/assets/contact-mid-image.jpg')] bg-cover bg-center brightness-[0.15]"></div>
            </div>

            <div className="relative z-20 mx-auto max-w-7xl px-6 lg:px-8 text-center mb-16 px-4">
                <h2 className="text-4xl font-extrabold mb-6">Our Impact and Global Presence</h2>
